...
class _PrayerPageState extends State<PrayerPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title:  Text("Prayer Times", style: TextStyle(color: AppColors.whitColor)),
          ...
          builder: (context, snapshot) {
            ...
            return Column(
              ...
              children: [
                ...
                prayerTimeCard("Maghrib", prayerTimes.maghrib, Icons.nights_stay),
                prayerTimeCard("Isha", prayerTimes.isha, Icons.nightlight_round),
              ],
            );
          },
        ),
      ...
      child: Container(
       ...
       // shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(20)),
        child: ListTile(
          ...
          title: Text(
            prayer,
            style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w600,color: AppColors.whitColor),
          ),
          trailing: Text(
            DateFormat.jm().format(time),
            style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w500,color: AppColors.whitColor),
          ),
        ),
      ),
    );
